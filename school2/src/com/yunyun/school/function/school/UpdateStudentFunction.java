...
//        Object studentPhoto = StringUtil.convertObject(params.get("student_photo").toString());
        ...
        /*-----------------查询学号是否重复-----------------*/
        Map studentMaps = DataContext.getContext().doHexByIdToMap("hex_school_student_queryStudentById","student_id="+studentId );
        if (!studentNo.equals(studentMaps.get("student_no"))){
        ...
        param.put("funcId", "hex_school_student_updateStudent");
