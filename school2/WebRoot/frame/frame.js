...
// 导入框架的css文件
document.write('<link rel="stylesheet" href="' + BASE_PATH + '/frame/hait/css/default.css?v=' + FRAME_VERSION + '" />');
document.write('<link rel="stylesheet" href="' + BASE_PATH + '/frame/hait/css/icon-old.css?v=' + FRAME_VERSION + '" />');
document.write('<link rel="stylesheet" href="' + BASE_PATH + '/frame/hait/css/icon.css?v=' + FRAME_VERSION + '" />');
 ...
 * 导入hait6.0框架的核心、常用类
 */
document.write('<script src="' + BASE_PATH + '/frame/plugins/jquery/jquery-1.12.3.min.js"></script>');
